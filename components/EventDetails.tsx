            ...
            <div className="details">
                ...
                <div className="content">
                    ...
                    <section className="flex-col-gap-2">
                        ...
                        <EventDetailItem icon="/calendar.svg" alt="calendar" label={date} />
                        <EventDetailItem icon="/clock.svg" alt="clock" label={time} />
                        <EventDetailItem icon="/pin.svg" alt="pin" label={location} />
